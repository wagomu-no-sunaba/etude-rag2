...
class GenerationState(BaseModel):
    ...
    selected_article_type: str | None = Field(default=None, description="選択された記事タイプ")
    generated_draft: dict[str, Any] | None = Field(default=None, description="生成されたドラフト")
...
class VerificationState(BaseModel):
    ...
    style_result: dict[str, Any] | None = Field(default=None, description="文体検証結果")
